...
public class Tc001 extends BaseClass{
	...
	private void bookAHotel() {
		...
		driver.findElement(By.name("last_name")).sendKeys("aswin");
		driver.findElement(By.xpath(".//textarea[@rows='4']")).sendKeys("some where in the world");
		...
		driver.findElement(By.id("cc_cvv")).sendKeys("873");
